...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-4" data-toggle="modal" data-target="#newSubmenu">Add New Submenu</a>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('menu/submenu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="icon" name="icon" placeholder="Submenu icon Name">
                    </div>
                    <div class="form-group">
