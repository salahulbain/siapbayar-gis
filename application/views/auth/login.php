            ...
            <div class="col-lg">
              <div class="p-4">
                <div class="text-center">
                  <img src="<?= base_url('assets/'); ?>logo/siap-bayar-kecil.png" alt="logo-image" class="img-circle">
                  <h1 class="h4 text-gray-900 mb-0"><b>SIAP</b>-<em>bayar</em></h1>
                  <p class="mb-1"><em class="text-primary">Sistem Informasi Aplikasi Pembayaran SPP Online</em></p>
